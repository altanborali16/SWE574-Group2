...
const MyCommunitiesPage = () => {
  ...
  return (
    <>
      ...
      <CommunityList communityList={subscribedCommunityList} title="Subscribed Communities" />
      {ownedCommunityListDb.length > 0 && (
        <CommunityListOld communityList={ownedCommunityListDb} title="Backend Owned Communities"/>
      )}
      {subscribedCommunityListDb.length > 0 && (
        <CommunityListOld communityList={subscribedCommunityListDb} title="Backend Subscribed Communities"/>
      )}
    </>
  );
};
